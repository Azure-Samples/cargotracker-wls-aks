...
```bash
export WLS_AKS_REPO_REF="test0223" # oracle/weblogic-azure reference
...
In the following sections, you use solution templates in [oralce/weblogic-azure](https://github.com/galiacheng/weblogic-azure/tree/test0223/weblogic-azure-aks/src/main/arm) to provision resources. Several parameters are required to invoke [mainTemplate.json](https://github.com/galiacheng/weblogic-azure/blob/test0223/weblogic-azure-aks/src/main/arm/mainTemplate.json). Parameters and their value are listed in the table. Make sure the variables have correct value.
